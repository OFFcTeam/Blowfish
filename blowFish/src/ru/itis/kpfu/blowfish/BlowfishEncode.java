...
public class BlowfishEncode {
    ...
    //____________ВСПОМОГАТЕЛЬНЫЕ ФУНКЦИИ_______________
    ...
    //_____________________КОНЕЦ ВСПОМОГАТЕЛЬНЫХ ФУНКЦИЙ_______________________
